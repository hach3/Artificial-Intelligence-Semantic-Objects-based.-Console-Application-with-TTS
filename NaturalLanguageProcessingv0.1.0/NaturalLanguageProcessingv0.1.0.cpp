...
int main()
{
	...
	std::vector<WORDS_TYPE> VWX = { INTERROGATIVE_PRONOUNS, AUXILIARY_VERBS, SUBJECT_PRONOUNS };
	std::vector<WORDS_TYPE> YZA = { INTERROGATIVE_PRONOUNS, AUXILIARY_VERBS, ABSTRACT_NOUNS };
	std::vector<WORDS_TYPE> BCD = { ATTRIBUTIVE_ADJECTIVES };
	std::vector<WORDS_TYPE> EFG = { INTERROGATIVE_PRONOUNS, AUXILIARY_VERBS, ATTRIBUTIVE_ADJECTIVES ,COMMON_NOUNS };
	std::vector<WORDS_TYPE> HIJ = { SUBJECT_PRONOUNS, AUXILIARY_VERBS, ATTRIBUTIVE_ADJECTIVES };
